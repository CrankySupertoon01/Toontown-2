...
buildingMinMax = {
    ...
    ToontownGlobals.ToonyTerrace: [config.GetInt('toony-terrace-building-min', 0),
                                     config.GetInt('toony-terrace-building-max', 3)],
    ...
    ToontownGlobals.PlanktonPath: [config.GetInt('plankton-path-building-min', 1),
                                     config.GetInt('plankton-path-building-max', 5)],
...
buildingChance = {
    ...
    ToontownGlobals.ToonyTerrace: config.GetFloat('toony-terrace-building-chance', 2.0),
    ...
    ToontownGlobals.PlanktonPath: config.GetFloat('plankton-path-building-chance', 75.0),
