...
ToonHall = 2513
HoodHierarchy = {ToontownCentral: (SillyStreet, LoopyLane, PunchlinePlace, ToonyTerrace),
 DonaldsDock: (BarnacleBoulevard, SeaweedStreet, LighthouseLane, PlanktonPath),
